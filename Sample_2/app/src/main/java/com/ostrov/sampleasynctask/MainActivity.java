...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateUi(Event earthquake) {
        ...
        tsunamiTextView.setText(getTsunamiAlertString(earthquake.getTsunamiAlert()));
    }
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        /** Update the screen with the given earthquake (which was the result of the {@link TsunamiAsyncTask}). */
        @Override
